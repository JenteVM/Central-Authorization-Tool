...
class RegistryLookupResource(Resource): #queries a singular registry instance
    ...
    def patch(self, db_id):
        ...
        - `user_auth_scheme`: the new user authentication scheme for the registry entry read the wiki entry at https://github.com/JenteVM/Central-Authorization-Tool/wiki/placeholder for more information about required scheme details, *has to be provided in the headers*.
        - `translation`: the new translation for the registry entry linking old auth levels to new ones. Read the wiki entry at https://github.com/JenteVM/Central-Authorization-Tool/wiki/placeholder, *has to be provided in the headers*.
